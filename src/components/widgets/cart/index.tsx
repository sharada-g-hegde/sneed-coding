...
//       <Container
//         className={cn(
//           "fixed z-50 flex-col bg-white transition-transform duration-300 ease-in-out",
//           // Mobile: bottom sheet
...
//         <Container className="items-center justify-center pt-3 lg:hidden">
...
//         <Container
//           component="div"
//           className="flex-col overflow-y-auto px-5 pb-5 pt-4 lg:pt-6"
//         >
//           <Typography className="m-0 font-outfit text-[22px] font-bold text-[#24232D]">
//             Cart ({itemCount})
//           </Typography>
...
//                     specialInstructions ? "translate-x-5.5" : "translate-x-0.5",
//                   )}
//                 />
//               </button>
//             </Container>
...
//         {/* Footer buttons — pinned below scroll area */}
      ...
      >
        ...
        {itemCount === 0 ? (
          <Container className="flex flex-1 flex-col items-center justify-center px-6 py-16 text-center">
            ...
            {/* Description */}
            <Typography className="mt-4 max-w-[470px] text-[17px] leading-[1.45] text-[#85838B]">
