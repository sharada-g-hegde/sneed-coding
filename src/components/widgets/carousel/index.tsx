...
//       <Container
//         width="pageWidth"
//         className="mx-auto flex-col lg:pl-16  pl-4 sm:pl-6"
//       >
//         <Container
//           width="fullWidth"
//           className="mb-6 flex-col items-start justify-between sm:mb-8 lg:flex-row lg:items-center"
//         >
//           <Typography className="m-0 text-[32px] font-outfit font-bold leading-[1.15] tracking-[-0.5px] sm:tracking-[-1.2px] lg:text-[56px] lg:tracking-[-1.5px]">
//             See it running on your type of product
//           </Typography>

//           <Container className="mt-4 shrink-0 items-center justify-start lg:gap-3 gap-2 lg:mt-0 lg:ml-8">
//             <button
//               type="button"
//               onClick={scrollLeft}
//               aria-label="Previous products"
//               className="flex lg:h-11 lg:w-11 h-8 w-8 cursor-pointer items-center justify-center rounded-full border border-[#9B1B32] bg-white text-[#9B1B32] transition-colors hover:bg-[#9B1B32] hover:text-white"
//             >
...
//         <div
//           ref={carouselRef}
//           className="flex snap-x snap-mandatory lg:gap-4 gap-2 overflow-x-auto scroll-smooth pb-1 pl-4 pr-4 sm:snap-none sm:gap-5 sm:pl-6 sm:pr-6 lg:pl-0 lg:pr-0 scrollbar-none [&::-webkit-scrollbar]:hidden"
//         >
...
//                 className="group relative h-50 w-[80vw] shrink-0 snap-start overflow-hidden rounded-[18px] bg-gray-200 xs:w-[280px] sm:h-100 sm:w-75 sm:snap-align-none sm:rounded-[18px] lg:h-135 lg:w-100 lg:rounded-[21px]"
//               >
//                 <Media
//                   src={thumbnail}
//                   alt={product.title}
...
//                 <button
//                   type="button"
//                   aria-label={`Play ${product.title} video`}
//                   className="absolute left-1/2 top-1/2 flex h-18 w-18 -translate-x-1/2 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full bg-white text-[#24232D] shadow-sm lg:h-15.5 lg:w-[62px]"
//                 >
//                   <Play
//                     size={40}
//                     fill="currentColor"
...
//                   <span className="block text-[18px] font-outfit font-semibold text-white sm:text-lg lg:text-[21px]">
//                     {product.title}
//                   </span>
...
//                 <Container className="absolute bottom-4 font-inter right-3 rounded-full bg-[#8E1729] px-2 py-0.5 lg:text-[10px] font-medium text-white sm:bottom-7 sm:right-5 sm:px-2.5 sm:py-1 text-[14px]">
//                   {product.duration}
//                 </Container>
//               </Link>
//             );
